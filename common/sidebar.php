...
<div class="d-block side-nav" id="side-nav">
  <?php if($layout == "layout1"){ include("iconbar.php"); } ?>
  <div class="logo-area">
    <svg class="logo" width="28" height="28">
      <!-- <use xlink:href="#bootstrap" /> -->
    </svg>
    <span class="name">Raj Accessories</span>
    <button class="toggle-side-nav">
      <span class="icon"><i data-feather="chevrons-left"></i></span>
    </button>
  </div>
  <ul class="p-3 pb-5 list-unstyled side-nav-scrollbar-overlay" id="parent-level">

    <?php $menuid = "dashboard"; ?>
    <li class="mb-1">
      <button class="btn btn-toggle align-items-center collapsed" data-bs-toggle="collapse" data-bs-target="#<?php echo $menuid; ?>-collapse"  aria-expanded="<?php echo $show_menu[$menuid] == "show" ? "true" : "false"; ?>">
        <span class="icon"><i data-feather="home"></i></span> <span class="txt">Dashboard</span>
      </button>
      <div class="collapse <?php echo $show_menu[$menuid]; ?>" id="<?php echo $menuid; ?>-collapse" data-bs-parent="#parent-level">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
          <li><a href="<?php echo ROOT_PATH; ?>/index.php" class="link-dark"><span>Dashboard</span></a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="mb-1">
      ...
      <div class="collapse" id="home-collapse" data-bs-parent="#parent-level">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/layout1.php" class="link-dark"><span>Layout 1</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-columns.php" class="link-dark"><span>Columns</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-table.php" class="link-dark"><span>Table</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-multi-progress.php" class="link-dark"><span>Multi Progress</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-chart.php" class="link-dark"><span>Graph / Chart</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-icon-counters.php" class="link-dark"><span>Icon Counters</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-graph-counters.php" class="link-dark"><span>Graph Counters</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-comments.php" class="link-dark"><span>Comments</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-task.php" class="link-dark"><span>Task</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-graph-tiles.php" class="link-dark"><span>Graph Tiles</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-progress-tiles.php" class="link-dark"><span>Progress Tiles</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-progress-percent.php" class="link-dark"><span>Progress Percent</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-user-grid.php" class="link-dark"><span>User Grid</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-chat.php" class="link-dark"><span>Chat</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-circle-chart.php" class="link-dark"><span>Circle Charts</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-file-grid.php" class="link-dark"><span>File Grid</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-project-grid.php" class="link-dark"><span>Project Grid</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-counter-percent.php" class="link-dark"><span>Counter Percent</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-mailbox.php" class="link-dark"><span>Mailbox</span></a></li>
          <li><a href="<?php echo ROOT_PATH; ?>/widgets/widget-form.php" class="link-dark"><span>Form</span></a></li>
    ...
    <li class="mb-1">
    <a href="<?php echo ROOT_PATH; ?>/modules/login/logout.php" class="link-dark">
      <button class="btn btn-toggle align-items-center">
        <span class="icon"><i data-feather="lock"></i></span><span class="txt"><span>Logout</span></span>
      </button>
    </a>
    </li>
    <?php /* for ($i=0; $i < 20; $i++) { ?>
    ...
    <li class="mb-1">
      <button class="btn btn-toggle align-items-center collapsed" data-bs-toggle="collapse" data-bs-target="#example<?php echo $i; ?>-collapse" aria-expanded="false">
        <span class="icon"><i data-feather="home"></i></span> <span class="txt">Dashboard <?php echo $i; ?></span>
      </button>
      <div class="collapse" id="example<?php echo $i; ?>-collapse" data-bs-parent="#parent-level">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
          <li><a href="#" class="link-dark"><span>Sample</span></a></li>
          <li><a href="#" class="link-dark"><span>Test page</span></a></li>
          <li><a href="#" class="link-dark"><span>Sample</span></a></li>
          <li><a href="#" class="link-dark"><span>Test page</span></a></li>
        </ul>
      </div>
