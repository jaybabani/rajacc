...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 03, 2026 at 04:01 PM
...
(14, 10, '', 'ready_for_dispatch', 20260702, 1, 1783079321, '1782985688_1');
...
(15, 14, 'test', 'draft', 20260703, 1, 1783078688, '1783078688_1');
...
(108, 15, 14, 15, 130.00, 103.00, 10, 1, 1783092129, '1783081754_1'),
(109, 15, 14, 16, 177.00, 203.00, 10, 1, 1783092129, '1783081754_1'),
(110, 15, 14, 17, 90.00, 303.00, 10, 1, 1783092129, '1783081754_1');
...
CREATE TABLE IF NOT EXISTS `ipadd` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
