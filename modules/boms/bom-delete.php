...
<div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1 g-4 py-3 px-2">
    ...
    $msg = [
        "success_delete" => "BOM deleted successfully",
        "error_delete" => "Error in deleting BOM",
    ];
    ...
    <form action="bom-delete.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-9 col-sm-10 col-xs-12">
                    <div class="form-group">
                        <label class="form-label" for="field-4">Are You sure you want to delete BOM?
                            <?php echo "<br>ID: <strong>" . get_module_id_prefix("boms") . get_value($data, 'id') . "</strong>";
                            $product = name_title(get_value($data, 'product'));
                            echo "<br>BOM of product: <strong>" . $product . "</strong>"; ?>
                            </label>
                    </div>
                </div>
            </div>
