...
<div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1 g-4 py-3 px-2">
    ...
    $titletag = "Delete Folder";

    $tablename = "folders";

    $msg = [
        "success_delete" => "Folder deleted successfully",
        "error_delete" => "Error in deleting folder",
    ];
    ...
    <form action="folder-delete.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-9 col-sm-10 col-xs-12">
                    <div class="form-group">
                        <label class="form-label" for="field-4">Are You sure you want to delete Folder?
