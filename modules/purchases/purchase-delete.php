...
<div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1 g-4 py-3 px-2">
    ...
    $titletag = "Delete Purchase";

    $tablename = "purchases";

    $msg = [
        "success_delete" => "Purchase deleted successfully",
        "error_delete" => "Error in deleting purchase",
    ];
    ...
    <form action="purchase-delete.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-9 col-sm-10 col-xs-12">
                    <div class="form-group">
                        <label class="form-label" for="field-4">Are You sure you want to delete Purchase?
                            <?php echo "<br>ID: <strong>" . get_value($data, 'id') . "</strong>";
                            $title = name_title(get_value($data, 'title'));
                            echo "<br>Title: <strong>" . $title . "</strong>"; ?></label>
                    </div>
                </div>
            </div>
        </div>
