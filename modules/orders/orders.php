...
<div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1 g-4 py-3 px-2">
  ...
  $customers_arr = fetch_data(["table" => "customers", "columns" => "id, firm_name", "condition" => "", "order" => "firm_name ASC", "limit" => ""]);    // print_arr($customers_arr);
  // print_arr($customers_arr);

  $users_arr = fetch_data(["table" => "users", "columns" => "id, name", "condition" => "", "order" => "name ASC", "limit" => ""]);    // print_arr($users_arr);
  // print_arr($users_arr);
  ...
  $display_columns = [
    ...
    ["name" => "Delivery Due Date", "column" => "delivery_due_date", "format" => "date", "class" => "nowrap"],
    ...
    ["name" => "Actions", "column" => "", "type" => "edit_delete", "sorting" => false, "search" => false, "class" => "nowrap", "acl" => ["edit" => "orders-update", "delete" => "orders-delete"]],
  ];
