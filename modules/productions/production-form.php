<?php
$module = "productions";
$pageid = "productions-create";
if (isset($_GET['id']) && is_numeric($_GET['id']) && trim($_GET['id']) != '') {
  $pageid = "productions-update";
}
...
<div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 row-cols-xxl-1 g-4 py-3 px-2">
  ...
  $id = '';
  $mode = "new";
  $titletag = T('Add New Production');
  if (isset($_GET['id']) && is_numeric($_GET['id']) && trim($_GET['id']) != '') {
    $mode = 'update';
    $titletag = T('Edit Production');
    $id = $_GET['id'];
  }
  ...
  $msg = [
    "success_update" => "Production updated successfully",
  ...
  <form class="row g-3 needs-validation" novalidate method="POST" enctype="multipart/form-data">
    ...
    echo form_field(["type" => "text", "name" => "Title", "key" => "title", "required" => true, "class" => "col-md-6 col-lg-4 mb-3"], $data);
    echo form_field(["type" => "select", "name" => "Status", "key" => "status", "required" => true, "options" => get_production_status_arr(), "class" => "col-md-6 col-lg-4 mb-3"], $data);
    ...
    echo form_field(["type" => "date", "name" => "Production placed on date", "key" => "production_date", "class" => "col-md-6 col-lg-4 mb-3"], $data);
